		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#cominctunavigationrouting-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"cominctunavigationrouting-display": {
								"semanticObject": "cominctunavigationrouting",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.inctu.navigationrouting",
									"url": sap.ui.require.toUrl("com/inctu/navigationrouting")
								}
							}
						}
					}
