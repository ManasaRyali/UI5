		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comincturejsonmodel-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comincturejsonmodel-display": {
								"semanticObject": "comincturejsonmodel",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.incture.jsonmodel",
									"url": sap.ui.require.toUrl("com/incture/jsonmodel")
								}
							}
						}
					}
